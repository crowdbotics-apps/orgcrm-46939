"""
Django settings for orgcrm_46939 project.
...
ROOT_URLCONF = 'orgcrm_46939.urls'
...
WSGI_APPLICATION = 'orgcrm_46939.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "orgcrm_46939 API",
    "DESCRIPTION": "API documentation for orgcrm_46939 App",
    "VERSION": "v1",
}
